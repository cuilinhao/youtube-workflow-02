...
const translations: TranslationMap = {
  zh: {
    ...
    'sidebar.tab.textToVideo': '批量文生视频',
    ...
    'main.textToVideo.title': '批量文生视频',
    'main.textToVideo.subtitle': '使用 Veo3 将文本描述转换为视频',
  ...
  en: {
    ...
    'sidebar.tab.textToVideo': 'Text → Video',
    ...
    'main.textToVideo.title': 'Batch Text to Video',
    'main.textToVideo.subtitle': 'Use Veo3 to convert text prompts into videos',
