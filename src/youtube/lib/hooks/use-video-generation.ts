...
import { generateVideoClient, pollVideoGeneration } from '@youtube/lib/video-generation-client';
        ...
        const videoUrl = await pollVideoGeneration(
          ...
          taskId,
          {
            ...
            onComplete: async (url) => {
              ...
              const downloadResponse = await fetch('/api/youtube/video-tasks/download', {
                method: 'POST',
