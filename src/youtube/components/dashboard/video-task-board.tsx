...
import { api, VideoTask } from '@youtube/lib/api';
 ...
 * @property {boolean} promptOnly - 文生视频模式：只需要提示词，不展示图片路径与上传
 */
...
export function VideoTaskBoard({
  ...
  const createTitle = promptOnly ? '✨ 新建文生视频任务' : '✨ 新建图生视频任务';
  const createDescription = promptOnly
    ? '填写视频提示词，一条提示词对应一个任务'
